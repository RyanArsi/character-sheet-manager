    ...
    @if($view === 'form')
        ...
        <form wire:submit="save" class="space-y-3">
            ...
            <div>
                ...
                <input type="text" wire:model="rank" dusk="equipment-rank"
                    class="w-full bg-gray-900 border border-gray-700 rounded px-2 py-1.5 text-white text-sm focus:border-amber-500 focus:ring-0 focus:outline-none">
            ...
            <p class="text-[10px] text-gray-600 -mt-1">Mesma notação da aba Dados — referencie a ficha pelo <span class="font-mono text-gray-500">nome</span> (ex.: <span class="font-mono text-gray-500">d20+forca</span>).</p>
